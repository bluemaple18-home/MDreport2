...
class SspApiTests(unittest.TestCase):
    ...
    def test_fetch_report_bundle_aggregates_multi_day_range_as_daily_chunks(self) -> None:
        ...
        self.assertEqual(int(bundle["pb"]), 0)
        ...
        mock_create.assert_any_call("ssp-token-14", start_day="2026-05-10", end_day="2026-05-10", pb=0)
        mock_create.assert_any_call("ssp-token-14", start_day="2026-05-11", end_day="2026-05-11", pb=0)
